/*
  ...
  2. Sécurité
    - Enable RLS
    - Policies pour la lecture par le destinataire
    - Policies pour l'édition par les admins

  3. Triggers
    - Création automatique de notifications pour les commandes
    - Création automatique de notifications pour les stocks bas
*/
