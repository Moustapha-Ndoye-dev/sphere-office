...
DROP POLICY IF EXISTS "Lecture publique des buckets" ON storage.buckets;
DROP POLICY IF EXISTS "Lecture publique des objets" ON storage.objects;
DROP POLICY IF EXISTS "Gestion des objets pour utilisateurs authentifiés" ON storage.objects;
